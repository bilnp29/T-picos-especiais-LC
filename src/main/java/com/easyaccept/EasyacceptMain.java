...
public class EasyacceptMain {
	...
	public static void main(String[] args) {
		 ...
		 /* args = new String[] { "com.easyaccept.FachadaEasyaccept",
		  "teste_aceitacao/US01.txt", "teste_aceitacao/US02.txt",
		  "teste_aceitacao/US03.txt", "teste_aceitacao/US04.txt",
		...
		args = new String[] { "com.easyaccept.FachadaEasyaccept", "teste_aceitacao/US13.txt" };
